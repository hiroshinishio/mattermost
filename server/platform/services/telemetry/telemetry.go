...
func (ts *TelemetryService) trackConfig() {
	...
	ts.SendTelemetry(TrackConfigExperimental, map[string]any{
		...
		"enable_shared_channels":              *cfg.ServerFederationSettings.EnableSharedChannels,
		"enable_remote_cluster_service":       *cfg.ServerFederationSettings.EnableRemoteClusterService && cfg.FeatureFlags.EnableRemoteClusterService,
